...
def setup_logger(name="master_etapa3"):
    ...
    log_file = os.getenv("LOG_FILE", "/var/log/ex4/master_etapa3.log")
    try:
    ...
    try:
        ...
        def on_result(ch, method, properties, body):
            try:
                ...
                # --- ETAPA 3: ACK manual del resultado ---
        ...
        res_ch.basic_consume(queue=QUEUE_RESULTS, on_message_callback=on_result, auto_ack=False)
